            ...
            <ScrollView>
                ...
                <View style={styles.rowview}>
                    <TouchableOpacity style={styles.timebtn}>
                        <Text style={styles.timetxt}>Monthly</Text>
                    </TouchableOpacity>
                    <TouchableOpacity style={styles.cashbtn} onPress={()=>{navigation.navigate('Quarter')}}>
                        <Text style={styles.cashtext}>Quarterly</Text>
                    </TouchableOpacity>
                ...
                <View style={styles.rowview}>
                    <Text style={styles.jantext}>Month</Text>
                ...
                <View style={styles.actulview}>
                    ...
                    <View style={styles.formrowview}>
                        <Text style={styles.jantext}>Feb</Text>
                    ...
                    <View style={styles.formrowview}>
                        <Text style={styles.jantext}>Mar</Text>
                        <TouchableOpacity style={styles.yesbtn}>
                            <Text style={styles.numtext}>00:00</Text>
                        </TouchableOpacity>
                        <TouchableOpacity style={styles.yesbtn}>
                    ...
                    <View style={styles.formrowview}>
                        <Text style={styles.jantext}>Apr</Text>
                        <TouchableOpacity style={styles.yesbtncolor}>
                            <Text style={styles.numtext}>00:00</Text>
                        </TouchableOpacity>
                        <TouchableOpacity style={styles.yesbtncolor}>
                    ...
                    <View style={styles.formrowview}>
                        <Text style={styles.jantext}>May</Text>
                        <TouchableOpacity style={styles.yesbtn}>
                            <Text style={styles.numtext}>00:00</Text>
                        </TouchableOpacity>
                        <TouchableOpacity style={styles.yesbtn}>
                    ...
                    <View style={styles.formrowview}>
                        <Text style={styles.jantext}>Jun</Text>
                        <TouchableOpacity style={styles.yesbtncolor}>
                            <Text style={styles.numtext}>00:00</Text>
                        </TouchableOpacity>
                        <TouchableOpacity style={styles.yesbtncolor}>
                    ...
                    <View style={styles.formrowview}>
                        <Text style={styles.jantext}>Jul</Text>
                        <TouchableOpacity style={styles.yesbtn}>
                            <Text style={styles.numtext}>00:00</Text>
                        </TouchableOpacity>
                        <TouchableOpacity style={styles.yesbtn}>
                    ...
                    <View style={styles.formrowview}>
                        <Text style={styles.jantext}>Aug</Text>
                        <TouchableOpacity style={styles.yesbtncolor}>
                            <Text style={styles.numtext}>00:00</Text>
                        </TouchableOpacity>
                        <TouchableOpacity style={styles.yesbtncolor}>
                    ...
                    <View style={styles.formrowview}>
                        <Text style={styles.jantext}>Sept</Text>
                        <TouchableOpacity style={styles.yesbtn}>
                            <Text style={styles.numtext}>00:00</Text>
                        </TouchableOpacity>
                        <TouchableOpacity style={styles.yesbtn}>
                    ...
                    <View style={styles.formrowview}>
                        <Text style={styles.jantext}>Oct</Text>
                        <TouchableOpacity style={styles.yesbtncolor}>
                            <Text style={styles.numtext}>00:00</Text>
                        </TouchableOpacity>
                        <TouchableOpacity style={styles.yesbtncolor}>
                    ...
                    <View style={styles.formrowview}>
                        <Text style={styles.jantext}>Nov</Text>
                        <TouchableOpacity style={styles.yesbtn}>
                            <Text style={styles.numtext}>00:00</Text>
                        </TouchableOpacity>
                        <TouchableOpacity style={styles.yesbtn}>
                    ...
                    <View style={styles.formrowview}>
                        <Text style={styles.jantext}>Dec</Text>
                        <TouchableOpacity style={styles.yesbtncolor}>
                            <Text style={styles.numtext}>00:00</Text>
                        </TouchableOpacity>
                        <TouchableOpacity style={styles.yesbtncolor}>
